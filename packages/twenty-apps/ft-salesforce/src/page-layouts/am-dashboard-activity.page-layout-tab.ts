...
export default definePageLayoutTab({
  ...
  widgets: [
    ...
    {
      universalIdentifier: 'a4be259a-87db-4620-9df0-c5e784d8b49f',
      title: 'Clients per Account Manager',
      type: 'GRAPH',
      objectUniversalIdentifier: DASHBOARD_COMPANY.object,
      gridPosition: { row: 26, column: 6, rowSpan: 6, columnSpan: 6 },
      configuration: {
        configurationType: 'BAR_CHART',
        layout: 'HORIZONTAL',
        aggregateFieldMetadataUniversalIdentifier: DASHBOARD_COMPANY.id,
        aggregateOperation: AggregateOperations.COUNT,
        primaryAxisGroupByFieldMetadataUniversalIdentifier: DASHBOARD_COMPANY.accountManager,
        primaryAxisGroupBySubFieldName: 'name.firstName',
        primaryAxisOrderBy: 'VALUE_DESC',
        omitNullValues: true,
        displayLegend: false,
        displayDataLabel: true,
        description: 'Client Success load only. Accounts per AM mixes teams, so a CS book of 33 live clients is dwarfed by a Sales book of renurture prospects.',
      },
    },
    {
